...
use App\Contracts\Repositories\ClothingAllowanceRepositoryInterface;
...
class ClothingAllowanceRepository implements ClothingAllowanceRepositoryInterface
{
    public function __construct(protected ClothingAllowance $model) {}

    public function getEmployeesWithAllowances(?string $search, ?int $officeId, ?int $employmentStatusId, ?int $month, ?int $year, int $perPage = 50): LengthAwarePaginator
    {
    ...
    {
        $allowance = $this->model->findOrFail($id);
