...
import { CreditCard, EllipsisVertical, History, Plus, Printer, Search, TrendingUp, User } from 'lucide-react';
                                        ...
                                        <TableCell className="text-center">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuItem onClick={() => router.get(route('ratas.history', employee.id))}>
