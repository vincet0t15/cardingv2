                                                        ...
                                                        className={
                                                            claim.claim_type.code === 'TRAVEL'
                                                                ...
                                                                : claim.claim_type.code === 'OVERTIME'
                                                                  ...
                                                                  : claim.claim_type.code === 'MEAL'
                                                                    ? 'border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-800 dark:bg-amber-900 dark:text-amber-300'
                                                                    : claim.claim_type.code === 'CASH_ADVANCE_TRAVEL'
                                                                      ? 'border-violet-200 bg-violet-50 text-violet-700 dark:border-violet-800 dark:bg-violet-900 dark:text-violet-300'
                                                                      : ''
                                                        }
                                                    >
