...
import { DollarSign, Filter, Plus, RefreshCcw, Search, Users, XCircle } from 'lucide-react';
...
export default function Index({ adjustments, employees, filters, statistics }: Props) {
    ...
    const getStatusBadge = (status: string) => {
        ...
        const Icon = icons[status] || RefreshCcw;

        return (
            <Badge className={`${variants[status] || variants.processed} gap-1 px-2 py-1`}>
