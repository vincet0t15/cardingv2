...
interface EmployeesByDeductionTypePrintProps {
    deduction_type: {
        id: number;
        name: string;
        code: string;
...
export default function EmployeesByDeductionTypePrint({ deduction_type, employees, summary, filters }: EmployeesByDeductionTypePrintProps) {
    ...
    return (
        <div className="mx-auto min-h-screen bg-white p-4 font-sans text-[11px] leading-[1.3] text-black print:max-w-none print:p-0">
            <Head title={`${deduction_type.name} - Employees Print`} />
                        ...
                        <tr>
                            <td>
                                <div className="mb-5 text-center">
                                    ...
                                    >
                                        {deduction_type.name.toUpperCase()} - EMPLOYEES
                                    </h2>
                                    <p className="m-[5px_0] text-[12px]">Deduction Type: {deduction_type.code}</p>
                                    ...
                                    <table className="w-full border-collapse border border-black">
                                        <thead>
                                            <tr className="bg-gray-100">
                                                ...
                                                <th className="w-24 border border-black px-2 py-1 text-right text-[10px] font-semibold">Deductions</th>
                                        ...
                                        <tbody>
                                            {employees.map((employee, index) => (
                                                <tr key={employee.id}>
                                                    ...
                                                    <td className="border border-black px-2 py-1 text-right text-[10px]">{employee.deduction_count}</td>
