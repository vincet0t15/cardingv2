...
export default function HazardPayPrint({ employees, month, year, totalHazardPay }: HazardPayPrintProps) {
                        ...
                        <tr>
                            <td>
                                ...
                                <table className="mb-4 w-full border-collapse border border-black text-[10px]">
                                    <tbody>
                                        <tr>
                                            <td className="border border-black p-1 font-bold">Total Hazard Pay</td>
                                            <td className="border border-black p-1 text-right">{formatCurrency(totalHazardPay)}</td>
                                ...
                                <table className="w-full border-collapse border border-black text-[10px]">
                                    <thead>
                                        <tr className="bg-gray-100">
                                            ...
                                            <th className="w-20 border border-black px-1 py-0.5 text-right">Hazard Pay</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {employees.length === 0 ? (
                                            ...
                                            <>
                                                ...
                                                <tr className="bg-gray-100 font-bold">
                                                    ...
                                                    <td className="border border-black px-1 py-0.5 text-right">{formatCurrency(totalHazardPay)}</td>
                                                </tr>
                                            </>
                                        )}
                                    </tbody>
