...
export default function SalariesIndex({ employees, offices, employmentStatuses, sourceOfFundCodes, filters }: SalariesProps) {
    ...
    const handlePrint = () => {
        ...
        window.open(`/salaries/print?${params.toString()}`, '_blank');
    };
    ...
    const employeesWithSalary = employees.data.filter((e) => e.latest_salary).length;
    const totalSalary = employees.data.reduce((sum, e) => sum + Number(e.latest_salary?.amount || 0), 0);
    const averageSalary = employeesWithSalary > 0 ? totalSalary / employeesWithSalary : 0;
    const highestSalary = Math.max(...employees.data.map((e) => Number(e.latest_salary?.amount || 0)));
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mt-2">
                    <Card className="border-0 bg-gradient-to-br from-indigo-600 to-sky-600 text-white shadow-lg">
                        ...
                        <CardContent>
                            ...
                            <p className="text-sm opacity-90">{employeesWithSalary} with salaries</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border-0 bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-lg">
                        ...
                        <CardContent>
                            <div className="text-3xl font-extrabold">{formatCurrency(totalSalary)}</div>
                    ...
                    <Card className="border-0 bg-gradient-to-br from-purple-500 to-violet-600 text-white shadow-lg">
                        ...
                        <CardContent>
                            <div className="text-3xl font-extrabold">{formatCurrency(averageSalary)}</div>
                    ...
                    <Card className="border-0 bg-gradient-to-br from-rose-500 to-amber-500 text-white shadow-lg">
                        ...
                        <CardContent>
                            <div className="text-3xl font-extrabold">{formatCurrency(highestSalary)}</div>
                                ...
                                <TableRow>
                                    <TableCell colSpan={3} className="py-12">
                                        <div className="flex flex-col items-center justify-center text-center">
                                            <Coins className="mb-3 h-16 w-16 text-gray-300 dark:text-gray-600" />
