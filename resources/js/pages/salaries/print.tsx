...
export default function SalaryPrint({ employees, month, year, totalSalary }: SalaryPrintProps) {
                        ...
                        <tr>
                            <td>
                                ...
                                <table className="mb-4 w-full border-collapse border border-black text-[10px]">
                                    <tbody>
                                        <tr>
                                            <td className="border border-black p-1 font-bold">Total Salary</td>
                                            <td className="border border-black p-1 text-right">{formatCurrency(totalSalary)}</td>
                                        ...
                                        {employees.length === 0 ? (
                                            ...
                                            <>
                                                {employees.map((employee, index) => (
                                                    <tr key={employee.id}>
                                                        ...
                                                        <td className="border border-black px-1 py-0.5 text-right font-medium">
                                                            {employee.latest_salary ? formatCurrency(Number(employee.latest_salary.amount)) : '-'}
                                                        </td>
                                                    </tr>
                                                ))}
                                                <tr className="bg-gray-100 font-bold">
                                                    ...
                                                    <td className="border border-black px-1 py-0.5 text-right">{formatCurrency(totalSalary)}</td>
                                                </tr>
                                            </>
                                        )}
                                    </tbody>
