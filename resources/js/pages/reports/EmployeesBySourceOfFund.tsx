            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div className="mb-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="flex flex-col">
                        <h2 className="text-lg font-semibold">Employee List by Source of Fund</h2>
                        <p className="text-sm text-muted-foreground">Filter below to narrow results before printing.</p>
                    </div>

                    <div className="flex items-center gap-2">
                        <Button type="button" onClick={handlePrint} disabled={!data.source_of_fund_code_id} className="bg-indigo-600 text-white hover:bg-indigo-700">
                            Print Report
                        </Button>
                    </div>
                </div>
                ...
                <div className="bg-card rounded-lg border p-4 shadow-sm">
                    <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4">
                        <div>
                            <label className="text-xs font-medium text-muted-foreground">Source of Fund</label>
                            <CustomComboBox
