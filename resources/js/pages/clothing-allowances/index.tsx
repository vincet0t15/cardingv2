...
interface ClothingAllowancesProps {
...
export default function ClothingAllowancesIndex({ employees, offices, employmentStatuses, filters }: ClothingAllowancesProps) {
    ...
    const handlePrint = () => {
        ...
        window.open(`/clothing-allowances/print?${params.toString()}`, '_blank');
    };
    ...
    const handleOpenAdd = (employee: Employee) => {
        ...
        setClothingAllowanceData('employee_id', employee.id);
        setOpenAdd(true);
    };

    const handleAddClothingAllowance = () => {
                ...
                <div className="mt-2 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <Card className="border-0 bg-gradient-to-br from-indigo-600 to-sky-600 text-white shadow-lg">
                        ...
                        <CardContent className="bg-transparent">
                            ...
                            <p className="text-sm opacity-90">{employeesWithClothing} with Clothing Allowance</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border-0 bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-lg">
                        ...
                        <CardContent className="bg-transparent">
                            <div className="text-3xl font-extrabold">{formatCurrency(totalClothing)}</div>
                    ...
                    <Card className="border-0 bg-gradient-to-br from-purple-500 to-violet-600 text-white shadow-lg">
                        ...
                        <CardContent className="bg-transparent">
                            <div className="text-3xl font-extrabold">{formatCurrency(averageClothing)}</div>
                    ...
                    <Card className="border-0 bg-gradient-to-br from-rose-500 to-amber-500 text-white shadow-lg">
                        ...
                        <CardContent className="bg-transparent">
                            <div className="text-3xl font-extrabold">{formatCurrency(highestClothing)}</div>
            ...
            <Dialog open={openAdd} onOpenChange={setOpenAdd}>
                <DialogContent>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                type="number"
                                step="0.01"
                                value={clothingAllowanceData.amount}
                                onChange={(e) => setClothingAllowanceData('amount', e.target.value)}
                            />
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleAddClothingAllowance}>Add Clothing Allowance</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </AppLayout>
