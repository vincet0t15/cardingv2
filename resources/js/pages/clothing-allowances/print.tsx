        ...
        <>
            ...
            <div className="p-8">
                <div className="mb-6 text-center">
                    <h1 className="text-2xl font-bold">Clothing Allowance Report</h1>
                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border p-2 text-right">Clothing Allowance</th>
                        </tr>
                    </thead>
                    <tbody>
                        {employees.map((employee, index) => (
                            <tr key={employee.id}>
                                ...
                                <td className="border p-2 text-right">
                                    {employee.latest_clothing_allowance ? formatCurrency(Number(employee.latest_clothing_allowance.amount)) : '-'}
                                </td>
                            </tr>
                        ))}
                        {employees.length === 0 && (
                    ...
                    <tfoot>
                        <tr className="bg-gray-50 font-bold">
                            ...
                            <td className="border p-2 text-right">{formatCurrency(totalClothingAllowance)}</td>
                        </tr>
                    </tfoot>
                </table>
