...
export const PrintReport = forwardRef<HTMLDivElement, PrintReportProps>(
    ({ employee, allDeductions, allClaims, filterMonth, filterYear, allAdjustments = [] }, ref) => {
        ...
        if (filterMonth && filterYear) {
            ...
            hazardPay = getHazardPayForPeriod(employee.hazard_pays, parseInt(filterYear), parseInt(filterMonth));
        } else if (filterYear) {
            ...
            hazardPay = getHazardPayForPeriod(employee.hazard_pays, parseInt(filterYear), 12);
        } else {
                                                        ...
                                                        <div className="text-[11px]">
                                                            ...
                                                            {(() => {
                                                                const periodAdj = (allAdjustments || [])
                                                                    .filter(
                                                                        (a: any) =>
                                                                            Number(a.pay_period_year) === year &&
                                                                            Number(a.pay_period_month) === month,
                                                                    )
                                                        ...
                                                        <table className="w-full border-collapse border border-black">
                                                            <thead>
                                                                <tr className="bg-gray-100">
                                                                    ...
                                                                    <th className="w-24 border border-black px-2 py-1 text-right text-[10px]">
                                                                        Amount
                                                                    </th>
                                                                </tr>
                                                            </thead>
                                                        ...
                                                        <table className="w-full border-collapse border border-black">
                                                            <thead>
                                                                <tr className="bg-gray-100">
                                                                    ...
                                                                    <th className="w-20 border border-black px-2 py-1 text-right text-[10px]">
                                                                        Amount
                                                                    </th>
                                                                </tr>
                                                            </thead>
