...
Route::middleware(['auth', 'active', 'linked'])->group(function () {
    ...
    // EMPLOYEE PRINT REPORT (placed after the source-of-fund routes so the {employee}
    // wildcard does not capture 'source-of-fund')
    ...
    Route::get('messenger/{conversation}/available-users', [ConversationController::class, 'availableUsers'])->name('messenger.conversations.available-users');
